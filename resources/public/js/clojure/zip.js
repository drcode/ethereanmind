...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(node,cljs.core.cst$kw$content,(function (){var and__6405__auto__ = children;
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12921,(1),null);
var vec__12924 = clojure.zip.children(loc);
...
var vec__12932 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12932,(0),null);
var map__12935 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12932,(1),null);
...
var path = map__12935__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12935__$1,cljs.core.cst$kw$l);
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12935__$1,cljs.core.cst$kw$ppath);
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12935__$1,cljs.core.cst$kw$pnodes);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12935__$1,cljs.core.cst$kw$r);
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12935__$1,cljs.core.cst$kw$changed_QMARK_);
if(cljs.core.truth_(pnodes)){
var pnode = cljs.core.peek(pnodes);
return cljs.core.with_meta((cljs.core.truth_(changed_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.zip.make_node(loc,pnode,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(l,cljs.core.cons(node,r))),(function (){var and__6405__auto__ = ppath;
if(cljs.core.truth_(and__6405__auto__)){
...
var vec__12946 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12946,(0),null);
var map__12949 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12946,(1),null);
var map__12949__$1 = ((((!((map__12949 == null)))?((((map__12949.cljs$lang$protocol_mask$partition0$ & (64))) || (map__12949.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12949):map__12949);
var path = map__12949__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12949__$1,cljs.core.cst$kw$l);
var vec__12950 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12949__$1,cljs.core.cst$kw$r);
...
var r = first__12952;
var rnext = seq__12951__$1;
var rs = vec__12950;
if(cljs.core.truth_((function (){var and__6405__auto__ = path;
if(cljs.core.truth_(and__6405__auto__)){
return rs;
} else {
return and__6405__auto__;
...
var vec__12959 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12959,(0),null);
var map__12962 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12959,(1),null);
var map__12962__$1 = ((((!((map__12962 == null)))?((((map__12962.cljs$lang$protocol_mask$partition0$ & (64))) || (map__12962.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12962):map__12962);
var path = map__12962__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12962__$1,cljs.core.cst$kw$l);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12962__$1,cljs.core.cst$kw$r);
if(cljs.core.truth_((function (){var and__6405__auto__ = path;
if(cljs.core.truth_(and__6405__auto__)){
return r;
} else {
...
var vec__12969 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12969,(0),null);
var map__12972 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12969,(1),null);
var map__12972__$1 = ((((!((map__12972 == null)))?((((map__12972.cljs$lang$protocol_mask$partition0$ & (64))) || (map__12972.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12972):map__12972);
var path = map__12972__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12972__$1,cljs.core.cst$kw$l);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12972__$1,cljs.core.cst$kw$r);
if(cljs.core.truth_((function (){var and__6405__auto__ = path;
if(cljs.core.truth_(and__6405__auto__)){
...
var vec__12979 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12979,(0),null);
var map__12982 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12979,(1),null);
...
var path = map__12982__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12982__$1,cljs.core.cst$kw$l);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12982__$1,cljs.core.cst$kw$r);
if(cljs.core.truth_((function (){var and__6405__auto__ = path;
if(cljs.core.truth_(and__6405__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__12989 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12989,(0),null);
var map__12992 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12989,(1),null);
...
var path = map__12992__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12992__$1,cljs.core.cst$kw$l);
if((path == null)){
throw "Insert at top";
} else {
...
var vec__12999 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12999,(0),null);
var map__13002 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12999,(1),null);
...
var path = map__13002__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13002__$1,cljs.core.cst$kw$r);
if((path == null)){
throw "Insert at top";
} else {
...
var vec__13007 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13007,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13007,(1),null);
...
var len__7492__auto___13013 = arguments.length;
var i__7493__auto___13014 = (0);
while(true){
if((i__7493__auto___13014 < len__7492__auto___13013)){
args__7499__auto__.push((arguments[i__7493__auto___13014]));

var G__13015 = (i__7493__auto___13014 + (1));
i__7493__auto___13014 = G__13015;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7500__auto__);
});
...
clojure.zip.edit.cljs$lang$applyTo = (function (seq13010){
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(G__13011,G__13012,seq13010__$2);
});
...
var or__6417__auto__ = (function (){var and__6405__auto__ = clojure.zip.branch_QMARK_(loc);
if(cljs.core.truth_(and__6405__auto__)){
...
var or__6417__auto____$1 = clojure.zip.right(loc);
...
var or__6417__auto____$2 = clojure.zip.right(clojure.zip.up(p));
if(cljs.core.truth_(or__6417__auto____$2)){
return or__6417__auto____$2;
} else {
var G__13016 = clojure.zip.up(p);
p = G__13016;
continue;
}
} else {
...
var loc__$1 = lloc;
while(true){
var temp__4655__auto____$1 = (function (){var and__6405__auto__ = clojure.zip.branch_QMARK_(loc__$1);
if(cljs.core.truth_(and__6405__auto__)){
...
var G__13017 = clojure.zip.rightmost(child);
loc__$1 = G__13017;
continue;
} else {
return loc__$1;
...
var vec__13023 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13023,(0),null);
var map__13026 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13023,(1),null);
...
var path = map__13026__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13026__$1,cljs.core.cst$kw$l);
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13026__$1,cljs.core.cst$kw$ppath);
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13026__$1,cljs.core.cst$kw$pnodes);
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13026__$1,cljs.core.cst$kw$r);
if((path == null)){
throw "Remove at top";
} else {
...
while(true){
var temp__4655__auto__ = (function (){var and__6405__auto__ = clojure.zip.branch_QMARK_(loc__$1);
if(cljs.core.truth_(and__6405__auto__)){
return clojure.zip.down(loc__$1);
} else {
return and__6405__auto__;
...
var G__13028 = clojure.zip.rightmost(child);
loc__$1 = G__13028;
continue;
} else {
return loc__$1;
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.zip.make_node(loc,cljs.core.peek(pnodes),rs),(function (){var and__6405__auto__ = ppath;
if(cljs.core.truth_(and__6405__auto__)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ppath,cljs.core.cst$kw$changed_QMARK_,true);
} else {
return and__6405__auto__;
