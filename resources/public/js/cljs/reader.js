...
var len__7492__auto___22499 = arguments.length;
var i__7493__auto___22500 = (0);
while(true){
if((i__7493__auto___22500 < len__7492__auto___22499)){
args__7499__auto__.push((arguments[i__7493__auto___22500]));

var G__22501 = (i__7493__auto___22500 + (1));
i__7493__auto___22500 = G__22501;
continue;
} else {
}
break;
...
cljs.reader.reader_error.cljs$lang$applyTo = (function (seq22497){
var G__22498 = cljs.core.first(seq22497);
var seq22497__$1 = cljs.core.next(seq22497);
return cljs.reader.reader_error.cljs$core$IFn$_invoke$arity$variadic(G__22498,seq22497__$1);
});
...
var G__22502 = (function (){
sb.append(ch);

return sb;
})()
;
var G__22503 = cljs.reader.read_char(rdr);
sb = G__22502;
ch = G__22503;
continue;
}
...
var a = (cljs.core.truth_((groups[(3)]))?[(groups[(3)]),(10)]:(cljs.core.truth_((groups[(4)]))?[(groups[(4)]),(16)]:(cljs.core.truth_((groups[(5)]))?[(groups[(5)]),(8)]:(cljs.core.truth_((groups[(6)]))?[(groups[(7)]),(function (){var G__22506 = (groups[(6)]);
var G__22507 = (10);
return parseInt(G__22506,G__22507);
})()]:[null,null]
))));
var n = (a[(0)]);
var radix = (a[(1)]);
...
var G__22508 = cljs.reader.read_char(rdr);
ch = G__22508;
continue;
} else {
return ch;
...
var G__22509 = (((mret === rdr))?a:(function (){
a.push(mret);
...
if((i > (0))){
var G__22511 = (i - (1));
var G__22512 = r.cljs$core$ICollection$_conj$arity$2(null,(arr[(i - (1))]));
i = G__22511;
r = G__22512;
continue;
} else {
...
var G__22513 = (function (){
buffer.append(ch);

return buffer;
})()
;
var G__22514 = cljs.reader.read_char(reader);
buffer = G__22513;
ch = G__22514;
continue;
}
...
if(("\\" === ch)){
var G__22515 = (function (){
buffer.append(cljs.reader.escape_char(buffer,reader));

return buffer;
})()
;
var G__22516 = cljs.reader.read_char(reader);
buffer = G__22515;
ch = G__22516;
continue;
} else {
...
var G__22517 = (function (){
buffer.append(ch);

return buffer;
})()
;
var G__22518 = cljs.reader.read_char(reader);
buffer = G__22517;
ch = G__22518;
continue;
...
var G__22523 = (function (){var G__22521 = buffer;
G__22521.append(nch);

return G__22521;
})();
var G__22524 = cljs.reader.read_char(reader);
buffer = G__22523;
ch = G__22524;
continue;
}
...
var G__22525 = (function (){var G__22522 = buffer;
G__22522.append(ch);

return G__22522;
})();
var G__22526 = cljs.reader.read_char(reader);
buffer = G__22525;
ch = G__22526;
continue;
...
var G__22529 = reader;
var G__22530 = eof_is_error;
var G__22531 = sentinel;
var G__22532 = is_recursive;
reader = G__22529;
eof_is_error = G__22530;
sentinel = G__22531;
is_recursive = G__22532;
continue;
} else {
if(cljs.reader.comment_prefix_QMARK_(ch)){
var G__22533 = (cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2(reader,ch) : cljs.reader.read_comment.call(null,reader,ch));
var G__22534 = eof_is_error;
var G__22535 = sentinel;
var G__22536 = is_recursive;
reader = G__22533;
eof_is_error = G__22534;
sentinel = G__22535;
is_recursive = G__22536;
continue;
} else {
...
if((res === reader)){
var G__22537 = reader;
var G__22538 = eof_is_error;
var G__22539 = sentinel;
var G__22540 = is_recursive;
reader = G__22537;
eof_is_error = G__22538;
sentinel = G__22539;
is_recursive = G__22540;
continue;
} else {
return res;
}
...
var vec__22547 = cljs.core.re_matches(cljs.reader.timestamp_regex,s);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22547,(0),null);
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22547,(1),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22547,(2),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22547,(3),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22547,(4),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22547,(5),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22547,(6),null);
var fraction = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22547,(7),null);
var offset_sign = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22547,(8),null);
var offset_hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22547,(9),null);
var offset_minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22547,(10),null);
var v = vec__22547;
if(cljs.core.not(v)){
...
return new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [years__$1,cljs.reader.check((1),months__$1,(12),"timestamp month field must be in range 1..12"),cljs.reader.check((1),days__$1,(function (){var G__22550 = months__$1;
var G__22551 = cljs.reader.leap_year_QMARK_(years__$1);
return (cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2(G__22550,G__22551) : cljs.reader.days_in_month.call(null,G__22550,G__22551));
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__22555 = temp__4655__auto__;
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22555,(0),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22555,(1),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22555,(2),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22555,(3),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22555,(4),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22555,(5),null);
var ms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22555,(6),null);
var offset = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22555,(7),null);
...
var arr = [];
var seq__22574_22590 = cljs.core.seq(form);
var chunk__22575_22591 = null;
var count__22576_22592 = (0);
var i__22577_22593 = (0);
while(true){
if((i__22577_22593 < count__22576_22592)){
var x_22594 = chunk__22575_22591.cljs$core$IIndexed$_nth$arity$2(null,i__22577_22593);
arr.push(x_22594);

var G__22595 = seq__22574_22590;
var G__22596 = chunk__22575_22591;
var G__22597 = count__22576_22592;
var G__22598 = (i__22577_22593 + (1));
seq__22574_22590 = G__22595;
chunk__22575_22591 = G__22596;
count__22576_22592 = G__22597;
i__22577_22593 = G__22598;
continue;
} else {
var temp__4657__auto___22599 = cljs.core.seq(seq__22574_22590);
if(temp__4657__auto___22599){
var seq__22574_22600__$1 = temp__4657__auto___22599;
if(cljs.core.chunked_seq_QMARK_(seq__22574_22600__$1)){
var c__7228__auto___22601 = cljs.core.chunk_first(seq__22574_22600__$1);
var G__22602 = cljs.core.chunk_rest(seq__22574_22600__$1);
var G__22603 = c__7228__auto___22601;
var G__22604 = cljs.core.count(c__7228__auto___22601);
var G__22605 = (0);
seq__22574_22590 = G__22602;
chunk__22575_22591 = G__22603;
count__22576_22592 = G__22604;
i__22577_22593 = G__22605;
continue;
} else {
var x_22606 = cljs.core.first(seq__22574_22600__$1);
arr.push(x_22606);

var G__22607 = cljs.core.next(seq__22574_22600__$1);
var G__22608 = null;
var G__22609 = (0);
var G__22610 = (0);
seq__22574_22590 = G__22607;
chunk__22575_22591 = G__22608;
count__22576_22592 = G__22609;
i__22577_22593 = G__22610;
continue;
}
} else {
}
...
var obj = {};
var seq__22580_22611 = cljs.core.seq(form);
var chunk__22581_22612 = null;
var count__22582_22613 = (0);
var i__22583_22614 = (0);
while(true){
if((i__22583_22614 < count__22582_22613)){
var vec__22584_22615 = chunk__22581_22612.cljs$core$IIndexed$_nth$arity$2(null,i__22583_22614);
var k_22616 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22584_22615,(0),null);
var v_22617 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22584_22615,(1),null);
(obj[cljs.core.name(k_22616)] = v_22617);

var G__22618 = seq__22580_22611;
var G__22619 = chunk__22581_22612;
var G__22620 = count__22582_22613;
var G__22621 = (i__22583_22614 + (1));
seq__22580_22611 = G__22618;
chunk__22581_22612 = G__22619;
count__22582_22613 = G__22620;
i__22583_22614 = G__22621;
continue;
} else {
var temp__4657__auto___22622 = cljs.core.seq(seq__22580_22611);
if(temp__4657__auto___22622){
var seq__22580_22623__$1 = temp__4657__auto___22622;
if(cljs.core.chunked_seq_QMARK_(seq__22580_22623__$1)){
var c__7228__auto___22624 = cljs.core.chunk_first(seq__22580_22623__$1);
var G__22625 = cljs.core.chunk_rest(seq__22580_22623__$1);
var G__22626 = c__7228__auto___22624;
var G__22627 = cljs.core.count(c__7228__auto___22624);
var G__22628 = (0);
seq__22580_22611 = G__22625;
chunk__22581_22612 = G__22626;
count__22582_22613 = G__22627;
i__22583_22614 = G__22628;
continue;
} else {
var vec__22587_22629 = cljs.core.first(seq__22580_22623__$1);
var k_22630 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22587_22629,(0),null);
var v_22631 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22587_22629,(1),null);
(obj[cljs.core.name(k_22630)] = v_22631);

var G__22632 = cljs.core.next(seq__22580_22623__$1);
var G__22633 = null;
var G__22634 = (0);
var G__22635 = (0);
seq__22580_22611 = G__22632;
chunk__22581_22612 = G__22633;
count__22582_22613 = G__22634;
i__22583_22614 = G__22635;
continue;
}
} else {
}
...
cljs.reader._STAR_tag_table_STAR_ = (function (){var G__22636 = new cljs.core.PersistentArrayMap(null, 4, ["inst",cljs.reader.read_date,"uuid",cljs.reader.read_uuid,"queue",cljs.reader.read_queue,"js",cljs.reader.read_js], null);
...
var G__22640 = cljs.reader.read(rdr,true,null,false);
return (pfn.cljs$core$IFn$_invoke$arity$1 ? pfn.cljs$core$IFn$_invoke$arity$1(G__22640) : pfn.call(null,G__22640));
} else {
if(cljs.core.truth_(dfn)){
var G__22641 = tag;
var G__22642 = cljs.reader.read(rdr,true,null,false);
return (dfn.cljs$core$IFn$_invoke$arity$2 ? dfn.cljs$core$IFn$_invoke$arity$2(G__22641,G__22642) : dfn.call(null,G__22641,G__22642));
} else {
