...
var G__56761 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__56761;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__56763 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__56763,ch);
...
if(("\\" === ch__$1)){
var ch_56764__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_56764__$2 == null)){
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading regex");
} else {
}

sb.append(ch_56764__$2);
} else {
}

var G__56765 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__56765;
continue;
}
}
...
var args56766 = [];
var len__32954__auto___56769 = arguments.length;
var i__32955__auto___56770 = (0);
while(true){
if((i__32955__auto___56770 < len__32954__auto___56769)){
args56766.push((arguments[i__32955__auto___56770]));

var G__56771 = (i__32955__auto___56770 + (1));
i__32955__auto___56770 = G__56771;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args56766.length)].join('')));
...
if(cljs.core.truth_((function (){var or__31879__auto__ = cljs.tools.reader.impl.utils.whitespace_QMARK_.call(null,ch);
if(or__31879__auto__){
return or__31879__auto__;
} else {
var or__31879__auto____$1 = cljs.tools.reader.macros.call(null,ch);
...
var vec__56780 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__56780,(0),null);
var start_column = cljs.core.nth.call(null,vec__56780,(1),null);
...
var G__56783 = cljs.core.conj_BANG_.call(null,a,form);
a = G__56783;
continue;
}
}
...
var _STAR_read_delim_STAR_56785 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_56785;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__56792 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__56792,(0),null);
var start_column = cljs.core.nth.call(null,vec__56792,(1),null);
var the_list = cljs.tools.reader.read_delimited.call(null,")",rdr,opts,pending_forms);
var vec__56795 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__56795,(0),null);
var end_column = cljs.core.nth.call(null,vec__56795,(1),null);
...
var vec__56804 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__56804,(0),null);
var start_column = cljs.core.nth.call(null,vec__56804,(1),null);
var the_vector = cljs.tools.reader.read_delimited.call(null,"]",rdr,opts,pending_forms);
var vec__56807 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__56807,(0),null);
var end_column = cljs.core.nth.call(null,vec__56807,(1),null);
...
var iter__32659__auto__ = (function cljs$tools$reader$duplicate_keys_error_$_duplicates_$_iter__56922(s__56923){
return (new cljs.core.LazySeq(null,(function (){
var s__56923__$1 = s__56923;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__56923__$1);
if(temp__4657__auto__){
var s__56923__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__56923__$2)){
var c__32657__auto__ = cljs.core.chunk_first.call(null,s__56923__$2);
var size__32658__auto__ = cljs.core.count.call(null,c__32657__auto__);
var b__56925 = cljs.core.chunk_buffer.call(null,size__32658__auto__);
if((function (){var i__56924 = (0);
while(true){
if((i__56924 < size__32658__auto__)){
var vec__56932 = cljs.core._nth.call(null,c__32657__auto__,i__56924);
var id = cljs.core.nth.call(null,vec__56932,(0),null);
var freq = cljs.core.nth.call(null,vec__56932,(1),null);
if((freq > (1))){
cljs.core.chunk_append.call(null,b__56925,id);

var G__56938 = (i__56924 + (1));
i__56924 = G__56938;
continue;
} else {
var G__56939 = (i__56924 + (1));
i__56924 = G__56939;
continue;
}
} else {
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__56925),cljs$tools$reader$duplicate_keys_error_$_duplicates_$_iter__56922.call(null,cljs.core.chunk_rest.call(null,s__56923__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__56925),null);
}
} else {
var vec__56935 = cljs.core.first.call(null,s__56923__$2);
var id = cljs.core.nth.call(null,vec__56935,(0),null);
var freq = cljs.core.nth.call(null,vec__56935,(1),null);
if((freq > (1))){
return cljs.core.cons.call(null,id,cljs$tools$reader$duplicate_keys_error_$_duplicates_$_iter__56922.call(null,cljs.core.rest.call(null,s__56923__$2)));
} else {
var G__56940 = cljs.core.rest.call(null,s__56923__$2);
s__56923__$1 = G__56940;
continue;
}
}
} else {
...
return iter__32659__auto__.call(null,cljs.core.frequencies.call(null,seq));
});
...
var vec__56947 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__56947,(0),null);
var start_column = cljs.core.nth.call(null,vec__56947,(1),null);
...
var vec__56950 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__56950,(0),null);
var end_column = cljs.core.nth.call(null,vec__56950,(1),null);
...
var sb = (function (){var G__56955 = (new goog.string.StringBuffer());
G__56955.append(initch);
...
var or__31879__auto__ = cljs.tools.reader.impl.commons.match_number.call(null,s);
...
var G__56957 = (function (){var G__56956 = sb;
G__56956.append(ch);

return G__56956;
})();
var G__56958 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__56957;
ch = G__56958;
continue;
}
...
switch (G__56965) {
case "\\":
var G__56969 = (function (){var G__56966 = sb;
G__56966.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__56966;
})();
var G__56970 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__56969;
ch = G__56970;
continue;
...
break;
default:
var G__56971 = (function (){var G__56967 = sb;
G__56967.append(ch);

return G__56967;
})();
var G__56972 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__56971;
ch = G__56972;
continue;
...
var vec__56976 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__56976,(0),null);
var end_column = cljs.core.nth.call(null,vec__56976,(1),null);
...
var vec__56983 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__56983,(0),null);
var column = cljs.core.nth.call(null,vec__56983,(1),null);
...
var or__31879__auto__ = cljs.core.get.call(null,cljs.tools.reader._STAR_alias_map_STAR_,sym);
if(cljs.core.truth_(or__31879__auto__)){
return or__31879__auto__;
} else {
...
return cljs.core._conj.call(null,(function (){var x__32713__auto____$1 = cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms);
...
var vec__56998 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__56998,(0),null);
var column = cljs.core.nth.call(null,vec__56998,(1),null);
...
var m__$1 = (cljs.core.truth_((function (){var and__31867__auto__ = line;
...
var vec__57003 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__57003,(0),null);
var column = cljs.core.nth.call(null,vec__57003,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"Metadata must be Symbol, Keyword, String or Map");
...
var start_line = cljs.core.nth.call(null,vec__57014,(0),null);
var start_column = cljs.core.nth.call(null,vec__57014,(1),null);
...
var vec__57017 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__57017,(0),null);
var end_column = cljs.core.nth.call(null,vec__57017,(1),null);
...
var G__57021 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__57021,true,null,opts,pending_forms);
...
var _STAR_suppress_read_STAR_57023 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_57023;
}});
...
var G__57025 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__57025,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__57025,rdr,first_line);

return G__57025;
} else {
var or__31879__auto__ = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
if(cljs.core.truth_(or__31879__auto__)){
return or__31879__auto__;
} else {
...
var G__57030 = matched;
var G__57031 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__57030;
finished = G__57031;
continue;
} else {
...
if(cljs.core.not.call(null,(function (){var and__31867__auto__ = opts;
if(cljs.core.truth_(and__31867__auto__)){
...
var _STAR_suppress_read_STAR_57033 = cljs.tools.reader._STAR_suppress_read_STAR_;
cljs.tools.reader._STAR_suppress_read_STAR_ = (function (){var or__31879__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__31879__auto__)){
return or__31879__auto__;
} else {
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_57033;
}}
} else {
return cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading character");
}
...
var arg_env57036 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__57037 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__57037,"(");
...
var G__57038 = (i + (1));
var G__57039 = cljs.core.conj_BANG_.call(null,args,(function (){var or__31879__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__31879__auto__)){
return or__31879__auto__;
} else {
...
return cljs.core._conj.call(null,(function (){var x__32713__auto__ = args;
return cljs.core._conj.call(null,(function (){var x__32713__auto____$1 = form;
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__32713__auto____$1);
})(),x__32713__auto__);
})(),new cljs.core.Symbol(null,"fn*","fn*",-752876845,null));
}finally {cljs.tools.reader.arg_env = arg_env57036;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__57041 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__57041);
...
var ret = cljs.core.conj_BANG_.call(null,r,(cljs.core.truth_(cljs.tools.reader.unquote_QMARK_.call(null,item))?cljs.core._conj.call(null,(function (){var x__32713__auto__ = cljs.core.second.call(null,item);
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__32713__auto__);
})(),new cljs.core.Symbol("clojure.core","list","clojure.core/list",-1119203325,null)):(cljs.core.truth_(cljs.tools.reader.unquote_splicing_QMARK_.call(null,item))?cljs.core.second.call(null,item):cljs.core._conj.call(null,(function (){var x__32713__auto__ = cljs.tools.reader.syntax_quote_STAR_.call(null,item);
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__32713__auto__);
})(),new cljs.core.Symbol("clojure.core","list","clojure.core/list",-1119203325,null))
)));
var G__57042 = cljs.core.next.call(null,s__$1);
var G__57043 = ret;
s__$1 = G__57042;
r = G__57043;
continue;
...
var G__57044 = cljs.core.next.call(null,s);
var G__57045 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__57044;
key_vals = G__57045;
continue;
} else {
...
var or__31879__auto__ = cljs.core.get.call(null,cljs.tools.reader.gensym_env,sym);
if(cljs.core.truth_(or__31879__auto__)){
return or__31879__auto__;
} else {
...
if((function (){var and__31867__auto__ = ((!((form == null)))?((((form.cljs$lang$protocol_mask$partition0$ & (262144))) || (form.cljs$core$IWithMeta$))?true:false):false);
...
return cljs.core._conj.call(null,(function (){var x__32713__auto__ = ret;
return cljs.core._conj.call(null,(function (){var x__32713__auto____$1 = cljs.tools.reader.syntax_quote_STAR_.call(null,cljs.core.meta.call(null,form));
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__32713__auto____$1);
})(),x__32713__auto__);
...
var res = cljs.core._conj.call(null,(function (){var x__32713__auto__ = cljs.core.cons.call(null,new cljs.core.Symbol("cljs.core","concat","cljs.core/concat",-1133584918,null),cljs.tools.reader.expand_list.call(null,coll));
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__32713__auto__);
})(),new cljs.core.Symbol("cljs.core","sequence","cljs.core/sequence",1908459032,null));
if(cljs.core.truth_(type)){
return cljs.core._conj.call(null,(function (){var x__32713__auto__ = type;
return cljs.core._conj.call(null,(function (){var x__32713__auto____$1 = res;
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__32713__auto____$1);
})(),x__32713__auto__);
...
return cljs.tools.reader.add_meta.call(null,form,((cljs.core.special_symbol_QMARK_.call(null,form))?cljs.core._conj.call(null,(function (){var x__32713__auto__ = form;
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__32713__auto__);
})(),new cljs.core.Symbol(null,"quote","quote",1377916282,null)):(((form instanceof cljs.core.Symbol))?cljs.core._conj.call(null,(function (){var x__32713__auto__ = (cljs.core.truth_((function (){var and__31867__auto__ = cljs.core.not.call(null,cljs.core.namespace.call(null,form));
if(and__31867__auto__){
...
))))):(cljs.core.truth_((function (){var or__31879__auto__ = (form instanceof cljs.core.Keyword);
if(or__31879__auto__){
return or__31879__auto__;
} else {
var or__31879__auto____$1 = typeof form === 'number';
if(or__31879__auto____$1){
return or__31879__auto____$1;
} else {
var or__31879__auto____$2 = typeof form === 'string';
if(or__31879__auto____$2){
return or__31879__auto____$2;
} else {
var or__31879__auto____$3 = (form == null);
if(or__31879__auto____$3){
return or__31879__auto____$3;
} else {
var or__31879__auto____$4 = cljs.tools.reader.bool_QMARK_.call(null,form);
if(cljs.core.truth_(or__31879__auto____$4)){
return or__31879__auto____$4;
} else {
...
})())?form:cljs.core._conj.call(null,(function (){var x__32713__auto__ = form;
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__32713__auto__);
})(),new cljs.core.Symbol(null,"quote","quote",1377916282,null))
)))))));
});
cljs.tools.reader.read_syntax_quote = (function cljs$tools$reader$read_syntax_quote(rdr,backquote,opts,pending_forms){
var gensym_env57053 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env57053;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__57056 = token;
var G__57056__$1 = (((G__57056 == null))?null:cljs.core.subs.call(null,G__57056,(1)));
var G__57056__$2 = (((G__57056__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__57056__$1));
var G__57056__$3 = (((G__57056__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__57056__$2));
var G__57056__$4 = (((G__57056__$3 == null))?null:cljs.core.symbol.call(null,G__57056__$3));
if((G__57056__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__57056__$4);
}
})():(function (){var G__57057 = token;
var G__57057__$1 = (((G__57057 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__57057));
if((G__57057__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__57057__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
var temp__4655__auto__ = (function (){var or__31879__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__31879__auto__)){
return or__31879__auto__;
} else {
...
var args57064 = [];
var len__32954__auto___57068 = arguments.length;
var i__32955__auto___57069 = (0);
while(true){
if((i__32955__auto___57069 < len__32954__auto___57068)){
args57064.push((arguments[i__32955__auto___57069]));

var G__57070 = (i__32955__auto___57069 + (1));
i__32955__auto___57069 = G__57070;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args57064.length)].join('')));
...
}catch (e57067){if((e57067 instanceof Error)){
var e = e57067;
...
var args57072 = [];
var len__32954__auto___57078 = arguments.length;
var i__32955__auto___57079 = (0);
while(true){
if((i__32955__auto___57079 < len__32954__auto___57078)){
args57072.push((arguments[i__32955__auto___57079]));

var G__57080 = (i__32955__auto___57079 + (1));
i__32955__auto___57079 = G__57080;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args57072.length)].join('')));
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__57075,reader){
var map__57076 = p__57075;
var map__57076__$1 = ((((!((map__57076 == null)))?((((map__57076.cljs$lang$protocol_mask$partition0$ & (64))) || (map__57076.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__57076):map__57076);
var opts = map__57076__$1;
var eof = cljs.core.get.call(null,map__57076__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var args57082 = [];
var len__32954__auto___57085 = arguments.length;
var i__32955__auto___57086 = (0);
while(true){
if((i__32955__auto___57086 < len__32954__auto___57085)){
args57082.push((arguments[i__32955__auto___57086]));

var G__57087 = (i__32955__auto___57086 + (1));
i__32955__auto___57086 = G__57087;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args57082.length)].join('')));
...
if(cljs.core.truth_((function (){var and__31867__auto__ = s;
if(cljs.core.truth_(and__31867__auto__)){
return !((s === ""));
} else {
return and__31867__auto__;
...
//# sourceMappingURL=reader.js.map?rel=1489123393009